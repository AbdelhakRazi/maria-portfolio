const projects = {
  "pop-club": {
    index: "01 / 04", title: "MOCHI MONSTERS", logo: "mochi-monsters", type: ["Licence de personnages + e-commerce", "Character franchise + e-commerce"],
  ...
  motif: {
    index: "02 / 04", title: "DAILY SPARKS", logo: "daily-sparks", type: ["Identité Instagram + direction de contenu", "Instagram identity + content direction"],
  ...
  "cafe-ora": {
    index: "03 / 04", title: "LUMA COFFEE", logo: "luma-coffee", type: ["Coffee shop + identité de marque", "Coffee shop + brand identity"],
  ...
  "pixel-papier": {
    index: "04 / 04", title: "PRINTNOVA", logo: "printnova", type: ["Retail + centre d’impression", "Retail + print centre"],
    ...
    colors: ["#00a4d6","#e72e87","#f2d52f","#171717"], words: ["NOVA", "PRINT / PACK / DELIVER"], next: "pop-club",
